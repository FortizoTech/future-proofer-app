// Simple mock of the validator function for testing logic
...
console.log(validateAIResponse(validJsonResponse, mockRetrievedData as any));

console.log("\nTesting Invalid JSON:");
console.log(validateAIResponse(invalidJsonResponse, mockRetrievedData as any));

console.log("\nTesting Markdown in JSON:");
console.log(validateAIResponse(markdownResponse, mockRetrievedData as any));
